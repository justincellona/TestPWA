 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var ve=class extends At{constructor(){super(...arguments);this.hasSlotController=new $o(this,"footer","header","image")}render(){return Pe`
      <div
        part="base"
...
`,be=class extends At{constructor(){super(...arguments);this.localize=new ko(this)}render(){return Pe`
...
`;var Fi=Object.defineProperty,Wi=Object.getOwnPropertyDescriptor,To=(e,t,r,o)=>{for(var n=o>1?void 0:o?Wi(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(n=(o?s(t,r,n):s(n))||n);return o&&n&&Fi(t,r,n),n};let _e=class extends V{constructor(){super();this.message="Welcome!"}static get styles(){return[zi,Ht`
    ...
    `}constructor(){super()}firstUpdated(){var t;new H((t=this.shadowRoot)==null?void 0:t.querySelector("#routerOutlet")).setRoutes([{path:"/TestPWA/",animate:!0,children:[{path:"",component:"app-home"},{path:"about",component:"app-about",action:async()=>{await Vo(()=>import("./app-about.65182999.js"),[])}}]}])}render(){return mt`
      <div>
        <main>
...
//# sourceMappingURL=index.13aeb040.js.map
